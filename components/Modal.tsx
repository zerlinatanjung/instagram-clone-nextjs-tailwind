...
function Modal() {
  ...
  return (
    <Transition.Root show={open} as={Fragment}>
      <Dialog
        as="div"
        className="fixed inset-10 z-10 overflow-y-auto"
        onClose={setOpen}
      >
        <div className="flex min-h-[800px] items-end justify-center px-4 pt-4 pb-20 text-center sm:block sm:min-h-screen sm:p-0">
          ...
          <Transition.Child
            as={Fragment}
            enter="ease-out duration-300"
            enterFrom="opcaity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
            enterTo="opcaity-100 translate-y-0 sm:scale-100"
            leave="ease-in duration-200"
